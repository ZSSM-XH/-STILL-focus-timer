...
` +
    ...
    var gt = Math.random().toString(36).slice(2),
      ...
      O = `__reactEvents$` + gt,
      k = `__reactListeners$` + gt,
      bt = `__reactHandles$` + gt,
      A = `__reactResources$` + gt,
      j = `__reactMarker$` + gt;
    function xt(e) {
      (delete e[_t], delete e[vt], delete e[O], delete e[k], delete e[bt]);
    }
    function St(e) {
      var t = e[_t];
      if (t) return t;
    ...
    function wi(e, t) {
      if (typeof e == `object` && e) {
        var n = Ci.get(e);
        return n === void 0
          ? ((t = { value: e, source: t, stack: je(t) }), Ci.set(e, t), t)
          : n;
      }
      ...
      for (var i = t, a = !1; i !== null; ) {
        ...
        if (i.tag === 10) {
          ...
          if (((o = o.memoizedProps), o !== null)) {
            var c = i.type;
            Or(i.pendingProps.value, o.value) ||
              (e === null ? (e = [c]) : e.push(c));
          }
    ...
    function Bo(e, t, n) {
      ...
      if (((a = e.baseState), i === null)) e.memoizedState = a;
        ...
        if (
          (l === null ? (o = a) : (l.next = c),
          !Or(a, e.memoizedState) && ((V = !0), d && ((n = va), n !== null)))
        )
          throw n;
        ((e.memoizedState = a),
          (e.baseState = o),
    ...
    function hc(e, t, n) {
      ...
      if (a !== null) {
        ...
        if ((fo(t), i))
          ...
          (V || ra(e, t, n, !1), (i = (n & e.childLanes) !== 0), V || i)
        ) {
          if (
            ((r = K),
            r !== null && ((o = dt(r, n)), o !== 0 && o !== a.retryLane))
          )
            throw ((a.retryLane = o), li(e, o), hu(r, e, o), ac);
          (Du(), (t = mc(e, t, n)));
        } else
          ((e = a.treeContext),
            (N = cf(o.nextSibling)),
    ...
    function wc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (a)
          ...
          (V || ra(e, t, n, !1), (o = (n & e.childLanes) !== 0), V || o)
        ) {
          if (
            ((o = K),
            o !== null && ((r = dt(o, n)), r !== 0 && r !== l.retryLane))
          )
            throw ((l.retryLane = r), li(e, r), hu(o, e, r), ac);
          (af(c) || Du(), (t = Dc(e, t, n)));
        } else
          af(c)
      ...
      switch (((t.lanes = 0), t.tag)) {
        ...
        case 5:
          return (
            ...
            t.memoizedState !== null &&
              ((i = Eo(e, t, ko, null, null, n)), (Qf._currentValue = i)),
            gc(e, t),
            oc(e, t, r, n),
            t.child
          );
      ...
      switch ((Li(t), t.tag)) {
        ...
        case 26:
          ...
          return (
            e === null
              ? (Fc(t),
                a === null ? (H(t), Ic(t, i, null, r, n)) : (H(t), Lc(t, a)))
              : a
                ? a === e.memoizedState
        ...
        case 27:
          if (
            ...
            ((e = _e.current),
              Ki(t) ? Wi(t, e) : ((e = ff(i, r, n)), (t.stateNode = e), Fc(t)));
          }
          return (H(t), null);
        case 5:
...
`,
  ...
  S = y(`check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]),
  ne = y(`chevron-right`, [[`path`, { d: `m9 18 6-6-6-6`, key: `mthhwq` }]]),
  re = y(`circle-question-mark`, [
  ...
  _e = y(`square-centerline-dashed-horizontal`, [
...
function De(e) {
  let t = new Uint32Array(1),
    n = Math.floor(4294967296 / e) * e;
  do crypto.getRandomValues(t);
  while (t[0] >= n);
  return (t[0] % e) + 1;
}
function Oe(e, t, n, r = Date.now()) {
  let i = structuredClone(e),
    a = i.flow;
  ((i.balance = Math.max(-100, i.balance)), (i.stats ??= ke(i)));
  let o = (...e) => {
    if (!a || !e.includes(a.stage))
      throw Error(`当前步骤已变化，请刷新后继续。`);
  };
  if (
    i.balance < 0 &&
    [`spin`, `options`, `note`, `accept`, `flip`].includes(t)
  )
    throw Error(`恢复模式下仅可专注，积分回到 0 后解锁其他功能。`);
  if (t === `start`) {
    if (a) throw Error(`请先完成当前流程。`);
    let e = String(n.task || ``).trim();
    if (!e || e.length > 100) throw Error(`请填写 1–100 字的专注任务。`);
    ((i.flow = {
      stage: `startReward`,
      task: e,
      kind: `focus`,
      ...
      (i.balance += i.flow.reward),
      (i.stats.earned += i.flow.reward));
  } else if (t === `roll`) {
    if ((o(`startReward`, `coin`), a.stage === `coin` && !a.heads))
      throw Error(`反面需要返回专注。`);
    ((a.die = De(6)), i.stats.dice[a.die - 1]++, (a.stage = `ready`));
  } else if (t === `begin`)
    (o(`ready`),
      (a.start = r),
      (a.end = r + a.die * 6e5),
    ...
    if ((o(`running`), r >= a.end))
      throw Error(`本次计时已结束，请领取完成奖励。`);
    ((a.pausedRemaining = a.end - r), (a.stage = `paused`));
  } else if (t === `resume`)
    (o(`paused`),
      (a.end = r + a.pausedRemaining),
      delete a.pausedRemaining,
      (a.stage = `running`));
  else if (t === `finish` || t === `cancel`) {
    o(`running`, `paused`);
    let e = a.stage === `running` && r >= a.end;
    if (t === `finish` && !e) throw Error(`时间还没到，请继续专注。`);
    let n = a.kind === `focus` && e ? De(100) : 0,
      s = i.balance;
    (a.kind === `focus` && !e && (i.balance = Math.max(-100, i.balance - 100)),
      (i.balance += n),
      (i.stats.earned += n));
    let c = e
      ? a.die * 600
    ...
    (i.history.unshift({
      ...
      completed: e,
      reward:
        a.kind === `focus` ? (e ? a.reward + n : a.reward + i.balance - s) : 0,
    }),
      (i.flow = e
        ? {
            ...a,
            stage: a.kind === `focus` ? `endReward` : `restDone`,
            reward: n,
          }
        : null));
  } else if (t === `dismiss`) {
    if (a && [`running`, `paused`].includes(a.stage))
      throw Error(`请先结束计时。`);
    if (a?.kind === `focus` && [`startReward`, `ready`].includes(a.stage)) {
      let e = i.balance;
      ((i.balance = Math.max(-100, i.balance - 100)),
        i.history.unshift({
          id: crypto.randomUUID(),
          task: a.task,
          kind: `focus`,
          ...
          ended: r,
          completed: !1,
          reward: a.reward + i.balance - e,
        }));
    }
    i.flow = null;
  } else if (t === `spin`) {
    if (a && ![`wheelResult`].includes(a.stage))
      throw Error(`请先完成当前流程。`);
    if (i.balance < 100)
      throw Error(`还差 ` + (100 - i.balance) + ` 点，先去专注吧。`);
    if (i.options.length < 2) throw Error(`至少添加两个放松选项。`);
    i.balance -= 100;
    let e = i.options[De(i.options.length) - 1];
    i.flow = { stage: `wheelResult`, task: e, kind: `rest`, selection: e };
  } else if (t === `accept`) (o(`wheelResult`), (a.stage = `coinReady`));
  else if (t === `flip`)
    (o(`coinReady`), (a.heads = De(2) === 1), (a.stage = `coin`));
  else if (t === `options`) {
    if (a) throw Error(`请先结束当前流程再修改选项。`);
    if (
      !Array.isArray(n.options) ||
      n.options.length < 2 ||
      n.options.length > 12
    )
      throw Error(`请保留 2–12 个选项。`);
    let e = n.options.map((e) => String(e).trim());
    if (e.some((e) => !e || e.length > 20) || new Set(e).size !== e.length)
      throw Error(`选项需不重复，每项 1–20 字。`);
    i.options = e;
  } else if (t === `note`) {
    if (typeof n.note != `string` || n.note.length > 5e3)
      throw Error(`便签最多 5000 字。`);
    i.note = n.note;
  } else if (t === `onboard`) i.onboarded = !0;
...
function ke(e) {
  ...
  let t =
    e.flow &&
    [`startReward`, `ready`, `running`, `paused`].includes(e.flow.stage)
      ? e.flow
      : null;
  return {
    dice: Array.from(
      { length: 6 },
      (n, r) =>
        e.history.filter((e) => e.minutes === (r + 1) * 10).length +
        +(t?.die === r + 1),
    ),
    earned:
      e.history
        .filter((e) => e.kind === `focus` && e.completed)
        .reduce((e, t) => e + t.reward, 0) +
      (t?.kind === `focus` ? (t.reward ?? 0) : 0),
  };
}
var Ae = `still-state-v1`;
function je(e = localStorage) {
  let t = e.getItem(Ae);
  if (!t) return Ee();
  let n;
  try {
    ...
    throw Error(`本机记录无法读取，原始数据已保留。请勿清除浏览器数据。`);
  }
  if (
    !n ||
    ...
    !Array.isArray(n.options) ||
    n.options.length < 2 ||
    !n.options.every((e) => typeof e == `string`) ||
    !(n.flow === null || typeof n.flow == `object`)
  )
    throw Error(`本机记录格式不完整，原始数据已保留。`);
  return { ...Ee(), ...n, balance: Math.max(-100, n.balance) };
}
async function Me(e, t, n) {
  let r = () => {
    let r = je();
    if (r.revision !== n)
      throw Error(`另一页面更新了记录，请重试以同步最新进度。`);
    let i = Oe(r, e, t);
    try {
      localStorage.setItem(Ae, JSON.stringify(i));
    } catch {
      throw Error(
        `浏览器未能保存，请检查存储空间或浏览器隐私设置；本次操作未生效。`,
      );
    }
    return i;
  };
  return typeof navigator < `u` && navigator.locks
    ? navigator.locks.request(`still-state`, r)
    : r();
}
var Ne = {
    rain: `./audio/rain.ogg`,
  ...
  Pe = class {
    ...
    async recording(e) {
      ...
      let t = await fetch(e);
      if (!t.ok) throw Error(`音频加载失败`);
      let n = await this.context.decodeAudioData(await t.arrayBuffer());
      return (this.cache.set(e, n), n);
    }
    prepare(e, t) {
      let n = Math.min(
          Math.floor(e.sampleRate * (t === `clock` ? 0.035 : 0.7)),
          Math.floor(e.length / 5),
        ),
        r = this.context.createBuffer(
          e.numberOfChannels,
          e.length - n,
          e.sampleRate,
        ),
      ...
      for (let t = 0; t < r.numberOfChannels; t++) {
        let o = e.getChannelData(t),
          s = r.getChannelData(t),
          c = 0;
        for (let e of o) c += e;
        c /= o.length;
        for (let e = 0; e < s.length; e++)
          ((s[e] =
            (e < n ? o[e] * (e / n) + o[s.length + e] * (1 - e / n) : o[e]) -
            c),
            (i += s[e] * s[e]),
            (a = Math.max(a, Math.abs(s[e]))));
      }
      let o = Math.sqrt(i / (r.length * r.numberOfChannels)),
        s = Math.min(0.085 / Math.max(o, 0.001), 0.48 / Math.max(a, 0.001), 3);
      for (let e = 0; e < r.numberOfChannels; e++) {
        let t = r.getChannelData(e);
        for (let e = 0; e < t.length; e++) t[e] *= s;
      }
      return r;
    }
    async play(e, t) {
      ...
      let r = this.context,
        i;
      if (Ne[e]) i = this.prepare(await this.recording(Ne[e]), e);
      else if (e === `pages`) {
        let e = await Promise.all(
          [`./audio/page1.ogg`, `./audio/page2.ogg`, `./audio/page3.ogg`].map(
            (e) => this.recording(e),
          ),
        );
        i = r.createBuffer(1, r.sampleRate * 32, r.sampleRate);
        let t = i.getChannelData(0);
        [2, 10, 19, 28].forEach((n, i) => {
          let a = e[i % 3],
            o = a.getChannelData(0),
            s = Math.floor(n * r.sampleRate),
            c = 0;
          for (let e of o) c = Math.max(c, Math.abs(e));
          let l = Math.min(0.26 / Math.max(c, 0.001), 2);
          for (
            let e = 0;
            e < a.duration * r.sampleRate && s + e < t.length;
            e++
          ) {
            let n = Math.min(
              o.length - 1,
              Math.floor((e * a.sampleRate) / r.sampleRate),
            );
            t[s + e] = o[n] * l;
          }
        });
      } else {
        i = r.createBuffer(1, r.sampleRate * 12, r.sampleRate);
        let t = i.getChannelData(0),
          n = 0,
          a = 0,
          o = 0,
        ...
        for (let r = 0; r < t.length; r++) {
          ...
          ((n = (n + i * 0.02) / 1.02),
            (a = 0.99765 * a + i * 0.099046),
            (o = 0.963 * o + i * 0.2965164),
            (s = 0.57 * s + i * 1.0526913));
          let c = (a + o + s + i * 0.1848) * 0.05;
          t[r] = e === `brown` ? n * 2 : e === `pink` ? c : i * 0.075;
        }
        i = this.prepare(i, e);
      }
      if (n !== this.generation) return !1;
      ...
      ((s.type = `highpass`), (s.frequency.value = 55), (s.Q.value = 0.5));
      let c = r.createGain();
      return (
        c.gain.setValueAtTime(0, r.currentTime),
        c.gain.linearRampToValueAtTime(t * 0.8, r.currentTime + 1.2),
        a.connect(s),
        s.connect(o),
        o.connect(c),
    ...
    volume(e) {
      this.gain &&
        this.context &&
        this.gain.gain.setTargetAtTime(e * 0.8, this.context.currentTime, 0.18);
    }
    stop() {
      this.generation++;
      let e = this.source,
      ...
      if (e && t && n) {
        (t.gain.cancelScheduledValues(n.currentTime),
          t.gain.setTargetAtTime(0, n.currentTime, 0.08));
        try {
          e.stop(n.currentTime + 0.4);
        } catch {}
      }
    ...
    async cue(e) {
      ...
      for (let r = 0; r < 8; r++) {
        let i = t.createOscillator(),
          a = t.createGain(),
          o = t.currentTime + r * 0.55,
          s = 5 - r * 0.55;
        ((i.type = e === `wood` ? `triangle` : `sine`),
          i.frequency.setValueAtTime(n[r % 4], o),
          e === `drop` &&
            i.frequency.exponentialRampToValueAtTime(n[r % 4] * 0.8, o + 0.3),
          a.gain.setValueAtTime(0, o),
          a.gain.linearRampToValueAtTime(0.052, o + 0.035),
          a.gain.exponentialRampToValueAtTime(1e-4, o + Math.min(s, 1.2)),
          i.connect(a),
          a.connect(t.destination),
          i.start(o),
          i.stop(o + Math.min(s, 1.2)),
          (i.onended = () => {
            (i.disconnect(), a.disconnect());
          }),
          this.cueNodes.push(i));
      }
    }
  },
  Fe = e((e) => {
  ...
  Ie = [
    { name: `原点`, id: `origin`, detail: `简洁 · 本真` },
    { name: `月相`, id: `moon`, detail: `月岩 · 大理石` },
    { name: `琥珀`, id: `amber`, detail: `繁花 · 黄铜` },
    { name: `极光`, id: `aurora`, detail: `流动 · 光幕` },
    { name: `星轨`, id: `orbit`, detail: `星辰 · 深空` },
  ];
function Le({
  variant: e = 0,
  seconds: t = 0,
  ...
  return (0, D.jsxs)(`div`, {
    className: `${o ? `clock-preview` : `instrument`} clockface dial-${l.id} ${i ? `resting-face` : ``} ${c ? `paused-face` : ``}`,
    style: { "--elapsed": `${n * 360}deg` },
    children: [
      (0, D.jsx)(`div`, { className: `case-ring` }),
      (0, D.jsx)(`div`, { className: `face-ticks` }),
      (0, D.jsx)(`div`, { className: `face-track` }),
      (0, D.jsx)(`div`, { className: `orbit-ring ring-a` }),
      (0, D.jsx)(`div`, { className: `orbit-ring ring-b` }),
      !o &&
        (0, D.jsx)(`div`, {
          className: `seconds-track ${r && !c ? `ticking` : ``}`,
          "aria-hidden": `true`,
          children: Array.from({ length: 60 }, (e, t) =>
            (0, D.jsx)(
              `i`,
              {
                className: `${t % 5 == 0 ? `major` : ``} ${t === s ? `lit` : ``}`,
      ...
      (0, D.jsxs)(`div`, {
        className: `face-cardinals`,
        "aria-hidden": `true`,
        children: [
          (0, D.jsx)(`span`, { children: `12` }),
          (0, D.jsx)(`span`, { children: `3` }),
          (0, D.jsx)(`span`, { children: `6` }),
          (0, D.jsx)(`span`, { children: `9` }),
        ],
      }),
      (0, D.jsx)(`div`, {
        ...
        "aria-hidden": `true`,
        children: i
          ? (0, D.jsx)(le, { strokeWidth: 1 })
          : l.id === `moon`
            ? (0, D.jsx)(ue, { strokeWidth: 0.75 })
            : l.id === `orbit`
              ? (0, D.jsx)(ve, { strokeWidth: 1 })
              : (0, D.jsx)(`span`, {}),
      }),
      (0, D.jsx)(`span`, {
      ...
      (0, D.jsxs)(`div`, {
        className: `face-time`,
        "aria-label": `${Math.floor(t / 60)}分${t % 60}秒`,
        children: [
          (0, D.jsx)(`span`, { children: u(Math.floor(t / 60)) }),
          (0, D.jsx)(`em`, { children: `:` }),
          (0, D.jsx)(`span`, { children: u(t % 60) }),
        ],
      }),
      (0, D.jsx)(`span`, {
        className: `face-note`,
      ...
      r && (0, D.jsx)(`span`, { className: `face-task`, children: a }),
      l.id === `amber` &&
        (0, D.jsx)(`div`, {
          className: `amber-signature`,
          "aria-hidden": `true`,
          children: `STILL`,
        }),
    ],
...
function Re({ variant: e, task: t }) {
  let n = Ie[e] || Ie[0];
  return (0, D.jsxs)(`div`, {
    className: `instrument clock-back back-${n.id}`,
    children: [
      (0, D.jsx)(`div`, { className: `back-plate` }),
      (0, D.jsx)(`i`, { className: `screw s1` }),
      (0, D.jsx)(`i`, { className: `screw s2` }),
      (0, D.jsx)(`i`, { className: `screw s3` }),
      (0, D.jsx)(`i`, { className: `screw s4` }),
      (0, D.jsxs)(`p`, {
        className: `back-edition`,
        children: [`STILL · `, n.name],
      }),
      (0, D.jsx)(`div`, {
        className: `mechanism`,
        children:
          e === 2
            ? (0, D.jsxs)(D.Fragment, {
                children: [
                  (0, D.jsx)(ie, { size: 75, strokeWidth: 0.6 }),
                  (0, D.jsx)(ie, { size: 48, strokeWidth: 0.8 }),
                ],
              })
            : e === 4
              ? (0, D.jsxs)(D.Fragment, {
                  children: [
                    (0, D.jsx)(`div`, { className: `back-orbit` }),
                    (0, D.jsx)(ve, { size: 34, strokeWidth: 0.8 }),
                  ],
                })
              : e === 1
                ? (0, D.jsx)(ue, { size: 49, strokeWidth: 0.8 })
                : e === 3
                  ? (0, D.jsx)(`div`, { className: `back-prism` })
                  : (0, D.jsxs)(`div`, {
                      className: `battery-cover`,
                      children: [
                        (0, D.jsx)(`span`, { children: `＋` }),
                        (0, D.jsx)(`span`, { children: `STILL` }),
                        (0, D.jsx)(`span`, { children: `−` }),
                      ],
                    }),
      }),
      (0, D.jsx)(`p`, {
        className: `back-engraving`,
        children: t || `时间的另一面，是留白。`,
      }),
      (0, D.jsxs)(`span`, {
        className: `back-serial`,
        children: [`MADE FOR THIS MOMENT · `, String(e + 1).padStart(2, `0`)],
      }),
      (0, D.jsxs)(`small`, {
        children: [
          (0, D.jsx)(he, { size: 11 }),
...
function ze({ open: e, onClose: t, title: n, children: r, className: i = `` }) {
  let a = (0, h.useRef)(null);
  return (
    (0, h.useEffect)(() => {
      (e && !a.current?.open && a.current?.showModal(),
        e || a.current?.close());
    }, [e]),
    (0, D.jsxs)(`dialog`, {
      ref: a,
      className: `utility-dialog ${i}`,
      "aria-label": n,
      onCancel: (e) => {
        (e.preventDefault(), t());
      },
...
var Be = [
  {
    icon: xe,
    title: `给这一刻，一个主题。`,
    text: `找一个适合安静专注的环境，先写下任务，再把时间交给一次骰子。每点 10 分钟，最长可能是 60 分钟。`,
    detail: `开始前，最好为自己预留完整的 60 分钟。`,
  },
  {
    icon: C,
    title: `投入时间，收下一点好运。`,
    text: `完成专注后，再抽取 1–100 点。100 点可以抽一个随机片刻；满意后抛硬币，正面才能掷骰子决定休息时长。`,
    detail: `反面返回专注 · 重新抽取也消耗 100 点`,
  },
  {
    icon: _e,
    title: `找到适合你的专注方式。`,
    text: `时钟有 60 道秒刻度。点击翻到背面，5 秒后进入沉浸计时；再次点击画面即可返回。右下角可以暂停，声音与便签始终留在手边。`,
    detail: `五套装扮 · 原点支持日夜切换`,
  },
  {
    icon: fe,
    title: `暂停一下，可以。取消有代价。`,
    text: `暂停会冻结倒计时；取消扣 100 点，时长不计入统计。最低 −100 点。负积分时只保留原点专注，其他功能暂时锁定，回到 0 后恢复。`,
    detail: `便签会一直保存，不随专注结束而清空`,
  },
];
function Ve({ open: e, onDone: t, busy: n }) {
  let [r, i] = (0, h.useState)(0);
  (0, h.useEffect)(() => {
    e && i(0);
  }, [e]);
  let a = Be[r],
  ...
  return (0, D.jsxs)(ze, {
    ...
    children: [
      (0, D.jsx)(`span`, { className: `guide-logo`, children: `◉` }),
      (0, D.jsxs)(`p`, {
        className: `eyebrow`,
        children: [`WELCOME TO STILL · `, r + 1, ` / 4`],
      }),
      (0, D.jsx)(o, { className: `guide-icon`, size: 35, strokeWidth: 1 }),
      (0, D.jsx)(`h2`, { children: a.title }),
      (0, D.jsx)(`p`, { children: a.text }),
      (0, D.jsx)(`small`, { children: a.detail }),
      (0, D.jsxs)(`div`, {
        className: `guide-bottom`,
        children: [
          (0, D.jsx)(`div`, {
            className: `guide-dots`,
            children: Be.map((e, t) =>
              (0, D.jsx)(
                `button`,
                {
                  "aria-label": `第 ${t + 1} 步`,
                  className: r === t ? `current` : ``,
                  onClick: () => i(t),
                },
                t,
              ),
...
function He({ open: e, onClose: t, value: n, onSave: r, saving: i }) {
  let [a, o] = (0, h.useState)(n),
    [s, c] = (0, h.useState)(!1),
    [l, u] = (0, h.useState)(!1),
    d = (0, h.useRef)(a);
  return (
    ...
    (0, D.jsxs)(ze, {
      ...
      children: [
        (0, D.jsx)(ye, { size: 26, strokeWidth: 1 }),
        (0, D.jsx)(`h2`, { children: `临时便签，长久保留。` }),
        (0, D.jsx)(`p`, { children: `把冒出的念头先放这里。` }),
        (0, D.jsx)(`textarea`, {
          "aria-label": `便签内容`,
          maxLength: 5e3,
          value: a,
          placeholder: `一个灵感、一句鼓励，或者待会儿再处理的事…`,
          onChange: (e) => {
            (o(e.target.value), u(!0), c(!1));
          },
        }),
        (0, D.jsxs)(`div`, {
          ...
          children: [
            ...
            s &&
              (0, D.jsx)(`button`, { onClick: () => c(!1), children: `重试` }),
          ],
        }),
      ],
    })
...
function Ge({
  ...
  let [c, l] = (0, h.useState)(`off`),
    [u, d] = (0, h.useState)(0.25),
    [f, p] = (0, h.useState)(!1),
    [m, g] = (0, h.useState)(``),
    _ = (0, h.useRef)(0);
  (0, h.useEffect)(() => {
    r && (_.current++, e?.stop(), e?.stopCue(), l(`off`), p(!1));
  }, [r, e]);
  async function v(n) {
    let r = ++_.current;
    (l(n), p(n !== `off`));
    try {
      ...
      r === _.current && (l(`off`), t(`音频未能加载，请重试。`));
    } finally {
      r === _.current && p(!1);
    }
  }
  return (0, D.jsxs)(`aside`, {
    className: `sound-control ${i ? `in-session` : ``}`,
    "aria-label": `声音与便签`,
    children: [
      (0, D.jsxs)(`div`, {
        children: [
          (0, D.jsx)(Se, { size: 15 }),
          (0, D.jsx)(`span`, { children: r ? `恢复模式` : `声音与灵感` }),
        ],
      }),
      (0, D.jsx)(`select`, {
        "aria-label": `白噪音`,
        ...
        (0, D.jsxs)(`div`, {
          ...
          children: [
            (0, D.jsx)(`input`, {
              ...
              value: u,
              onChange: (t) => {
                (d(+t.target.value), e?.volume(+t.target.value));
              },
            }),
            (0, D.jsx)(`button`, {
              "aria-label": `关闭声音`,
              onClick: () => v(`off`),
              children: (0, D.jsx)(Ce, { size: 16 }),
            }),
          ],
        }),
      !r &&
        (0, D.jsxs)(D.Fragment, {
          children: [
            (0, D.jsxs)(`details`, {
              ...
              children: [
                (0, D.jsxs)(`summary`, {
                  children: [(0, D.jsx)(ee, { size: 14 }), `完成提醒`],
                }),
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, D.jsxs)(`button`, {
                      disabled: a === `off`,
                      onClick: () =>
                        e?.cue(a).catch(() => g(`请再次点击试听。`)),
                      children: [(0, D.jsx)(pe, { size: 13 }), `试听 · 5 秒`],
                    }),
                    (0, D.jsxs)(`button`, {
                      onClick: async () => {
                        if (o) {
                    ...
                    (0, D.jsx)(`p`, {
                      className: `hint`,
                      children: `保持网页打开。刷新后点击试听，重新启用提示音。`,
                    }),
                    m &&
                      (0, D.jsx)(`p`, {
                        className: `hint`,
            ...
            (0, D.jsxs)(`button`, {
              ...
              onClick: n,
              children: [(0, D.jsx)(ye, { size: 14 }), `临时便签`],
            }),
            !i &&
              (0, D.jsx)(`a`, {
      ...
      r &&
        (0, D.jsx)(`p`, { className: `hint`, children: `积分回到 0 后解锁` }),
    ],
  });
}
function Ke({ variant: e, quiet: t = !1 }) {
  ...
  return (
    (0, h.useEffect)(() => {
      ...
      function c(e) {
        ...
        let n = r.clientWidth,
          l = r.clientHeight,
          u = Math.min(devicePixelRatio, 1.5);
        ((r.width !== Math.floor(n * u) || r.height !== Math.floor(l * u)) &&
          ((r.width = n * u), (r.height = l * u)),
          i.setTransform(u, 0, 0, u, 0, 0),
          i.clearRect(0, 0, n, l));
        for (let r = 0; r < 65; r++) {
          let a = (((r * 137.508) % 100) / 100) * n,
            c = (((r * 73.319) % 100) / 100) * l;
          ((i.globalAlpha =
            (0.12 +
              (o.matches
                ? 0.55
            ...
            (i.shadowBlur = 4 + (r % 4)),
            i.beginPath(),
            i.arc(a, c, r % 7 == 0 ? 1.6 : 0.75, 0, Math.PI * 2),
            i.fill());
        }
        o.matches || (a = requestAnimationFrame(c));
      }
      return (c(s), () => cancelAnimationFrame(a));
    }, [e, t]),
    (0, D.jsxs)(`div`, {
      className: `atmosphere atmosphere-${e} ${t ? `quiet` : ``}`,
      "aria-hidden": `true`,
      children: [
        e === 3 &&
          (0, D.jsxs)(D.Fragment, {
            children: [
              (0, D.jsx)(`i`, { className: `aurora-ribbon one` }),
              (0, D.jsx)(`i`, { className: `aurora-ribbon two` }),
              (0, D.jsx)(`i`, { className: `aurora-ribbon three` }),
            ],
          }),
        e === 4 && (0, D.jsx)(`canvas`, { ref: n }),
      ],
    })
  );
}
var qe = [be, ue, le, se, ge, ce, w, ae, de, ve],
  Je = [
    `#d0cfc9`,
    `#bcc8df`,
    `#b2b8ad`,
  ...
  Ye = [0, 1, 3, 9, 6],
  Xe = (e) => `${e.getFullYear()}-${e.getMonth()}-${e.getDate()}`,
  Ze = (e) => String(e).padStart(2, `0`);
function Qe() {
  let [e, t] = (0, h.useState)(Ee),
    [n, r] = (0, h.useState)(!1),
    [i, a] = (0, h.useState)(!0),
    [o, s] = (0, h.useState)(`focus`),
    [c, l] = (0, h.useState)(``),
    [u, d] = (0, h.useState)(0),
    [f, p] = (0, h.useState)(0),
    [m, g] = (0, h.useState)(``),
    ...
    [ie, C] = (0, h.useState)(!1),
    [ae, se] = (0, h.useState)(``),
    [ce, de] = (0, h.useState)(0),
    [w, he] = (0, h.useState)(0),
    [ge, _e] = (0, h.useState)(`off`),
    [ve, ye] = (0, h.useState)(0.45),
    [Se, Ce] = (0, h.useState)(7),
    [Te, De] = (0, h.useState)(`all`),
    [Oe, Ae] = (0, h.useState)(`bell`),
    [Ne, Fe] = (0, h.useState)(!1),
    [ze, Be] = (0, h.useState)(``),
    [Ue, We] = (0, h.useState)(``),
    [Qe, tt] = (0, h.useState)(!1),
    [nt, rt] = (0, h.useState)(!1),
    [it, at] = (0, h.useState)(!1),
    [ot, st] = (0, h.useState)(!1),
    [ct, lt] = (0, h.useState)(!1),
    [ut, dt] = (0, h.useState)(1),
    ft = (0, h.useRef)(null),
    pt = (0, h.useRef)(e),
    mt = (0, h.useRef)(!1),
    ht = (0, h.useRef)(!1),
  ...
  (0, h.useEffect)(() => {
    ft.current = new Pe();
    try {
      let e = JSON.parse(localStorage.getItem(`still-preferences`) || `{}`);
      (a(e.night ?? !0),
        de(
          e.clockVersion === 2
            ? Math.min(4, Math.max(0, e.clock || 0))
            : ({ 0: 0, 1: 1, 3: 2, 6: 4, 9: 3 }[e.clock] ?? 0),
        ),
        Ae(e.cue || `bell`),
        Fe(
          e.desktop === !0 &&
    ...
    (d(Date.now()), vt());
    let e = setInterval(() => d(Date.now()), 250),
      t = () => {
        document.visibilityState === `visible` && vt();
      };
    document.addEventListener(`visibilitychange`, t);
    let n = (e) => {
      (e.key === `still-state-v1` || e.key === null) && t();
    };
    window.addEventListener(`storage`, n);
    let r = setInterval(t, 15e3);
    return () => {
      ((_t.current = !1),
        clearInterval(e),
        clearInterval(r),
  ...
  function yt(e, t, n, r = Oe, i = Ne) {
    (a(e), de(t), he(n), Ae(r), Fe(i));
    try {
  ...
  async function O(e, n = {}) {
    if (mt.current) return null;
    ((e === `start` || e === `begin` || e === `resume`) &&
      (pt.current.balance >= 0 && ft.current?.unlock().catch(() => {}), Be(``)),
      (mt.current = !0),
      g(e),
      v(``));
    try {
      let i = Date.now(),
        a = pt.current.balance,
        o = pt.current.flow?.stage,
        s = { state: await Me(e, n, pt.current.revision), now: Date.now() };
      if (
        ((pt.current = s.state),
        [`roll`, `spin`, `flip`, `start`].includes(e) &&
          (await new Promise((e) =>
            setTimeout(e, Math.max(0, 1e3 - (Date.now() - i))),
          )),
        s.state &&
          (s.state.flow?.stage === `endReward` &&
            o !== `endReward` &&
            (st(!1), at(!1), lt(!0), setTimeout(() => lt(!1), 1800)),
          t(s.state),
          p(0),
          r(!0)),
        a >= 0 &&
          s.state.balance >= 0 &&
          [`finish`, `cancel`].includes(e) &&
          [`endReward`, `restDone`].includes(s.state.flow?.stage || ``))
      ) {
        let e = s.state.flow,
          t =
            e.kind === `focus`
              ? `专注完成！${e.task} · ${e.die * 10} 分钟。给自己的坚持一点掌声。`
              : `休息结束，愿你已经充满能量。`;
        if (
          (Be(t),
          ft.current?.cue(Oe).catch(() => We(`点击试听以启用提示音。`)),
          Ne &&
            typeof Notification < `u` &&
            Notification.permission === `granted`)
        )
          try {
            new Notification(
              `STILL · ` + (e.kind === `focus` ? `专注完成` : `休息结束`),
              { body: t, icon: `./favicon.svg`, tag: `still-complete` },
            );
          } catch {
            We(`当前浏览器不支持桌面通知，页面内提醒已开启。`);
          }
      }
      return s.state;
    } catch (e) {
  ...
  let k = e.flow,
    bt = k?.stage === `paused`,
    A = k?.stage === `running` || bt,
    j = k?.kind === `rest`,
    xt = A
      ? Math.max(0, Math.ceil((bt ? k.pausedRemaining : k.end - (u + f)) / 1e3))
      : (k?.die || 0) * 600;
  ((0, h.useEffect)(() => {
    (A &&
      !bt &&
  ...
  ((0, h.useEffect)(() => {
    ...
    (0, h.useEffect)(() => {
      if (m !== `start` && !ct) return;
      let e = setInterval(() => dt(Math.floor(Math.random() * 100) + 1), 65);
      return () => clearInterval(e);
    }, [m, ct]),
    (0, h.useEffect)(() => {
      y ? gt.current?.showModal() : gt.current?.close();
    }, [y]),
    (0, h.useEffect)(() => {
          ...
          e.registerTool(
            {
              ...
              description: `Read current focus session, points balance, and saved session count.`,
              inputSchema: {
                type: `object`,
                properties: {},
  ...
  let wt = Ye[Ct] ?? 0,
    ...
    Et = e.history.filter(
      (e) =>
        e.kind === `focus` &&
        e.completed &&
        Xe(new Date(e.ended)) === Xe(new Date(u || Date.now())),
    ),
    Dt = Math.floor(Et.reduce((e, t) => e + t.elapsed, 0) / 60),
    Ot = e.history.filter((e) => e.kind === `focus`).filter((e) => e.completed),
    kt = Array.from({ length: Se }, (e, t) => {
      let n = new Date(u || Date.now());
      return (
        n.setDate(n.getDate() - (Se - 1 - t)),
        {
          d: n,
          mins: Ot.filter((e) => Xe(new Date(e.ended)) === Xe(n)).reduce(
            (e, t) => e + t.elapsed / 60,
            0,
          ),
        }
    ...
    At = 0,
    jt = new Date(u || Date.now());
  for (
    Ot.some((e) => Xe(new Date(e.ended)) === Xe(jt)) ||
    jt.setDate(jt.getDate() - 1);
    Ot.some((e) => Xe(new Date(e.ended)) === Xe(jt));
  )
    (At++, jt.setDate(jt.getDate() - 1));
  let { dice: Mt, earned: Nt } = ke(e),
    Pt = A ? 1 - xt / (k.die * 600) : 0,
    Ft = A
      ? (((k.die * 600 - xt) % 60) + 60) % 60
      : new Date(u || 0).getSeconds(),
    It = () =>
      (0, D.jsx)(`button`, {
        className: `clock-flipper ${it ? `is-flipped` : ``}`,
        "aria-label": it ? `翻回时钟正面` : `翻看时钟背面，5 秒后进入沉浸计时`,
        onClick: () => at(!it),
        children: (0, D.jsxs)(`div`, {
          className: `clock-flip-inner`,
          children: [
            (0, D.jsx)(`div`, {
              className: `clock-front`,
              children: (0, D.jsx)(Le, {
                variant: Ct,
                seconds: xt,
                progress: Pt,
            ...
            (0, D.jsx)(`div`, {
              className: `clock-reverse`,
              children: (0, D.jsx)(Re, { variant: Ct, task: k?.task || c }),
            }),
          ],
        }),
      });
  async function Lt() {
    (await O(`dismiss`)) && (s(`focus`), C(!1));
  }
  let Rt = [
      [`focus`, xe, `专注`],
      [`wheel`, oe, `随机片刻`],
    ...
    Bt =
      k?.kind === `focus` &&
      [`startReward`, `ready`, `running`, `paused`].includes(k.stage);
  return (0, D.jsxs)(`main`, {
    "data-theme": Ct === 0 ? (i ? `dark` : `light`) : `dark`,
    "data-skin": Ie[Ct].id,
    className: `${A ? `immersive` : ``} ${j ? `rest-mode` : ``} ${St ? `debt-mode` : ``} ${ot ? `zen-mode` : ``}`,
    children: [
      (0, D.jsx)(Ke, { variant: Ct, quiet: A }),
      !A &&
        (0, D.jsxs)(D.Fragment, {
          children: [
            (0, D.jsxs)(`header`, {
              children: [
                ...
                (0, D.jsxs)(`div`, {
                  ...
                  children: [
                    u
                      ? `${Ze(new Date(u).getHours())}:${Ze(new Date(u).getMinutes())}`
                      : `—:—`,
                    (0, D.jsx)(`span`, { children: `LOCAL TIME` }),
                  ],
                }),
                (0, D.jsxs)(`div`, {
                  className: `wallet`,
                  "aria-label": `积分余额 ${e.balance}`,
                  children: [
                    (0, D.jsx)(Tt, { size: 21 }),
                    (0, D.jsx)(`b`, {
                      children: n ? e.balance.toLocaleString() : `—`,
                    }),
                    (0, D.jsx)(`span`, { children: `灵感点数` }),
                  ],
                }),
              ],
            }),
            (0, D.jsx)(`nav`, {
              "aria-label": `主要页面`,
              children: Rt.map(([e, t, n]) =>
                (0, D.jsxs)(
                  `button`,
                  {
                    className: !zt && o === e ? `active` : ``,
                    disabled: zt || !!m || (St && e !== `focus`),
                    onClick: () => {
                      (s(e), C(!1), v(``));
                    },
                    children: [
      ...
      St &&
        ...
        (0, D.jsxs)(`p`, {
          ...
          children: [
            `恢复模式 · 积分 `,
            e.balance,
            `，最低 −100。专注使积分回到 0 后，其他功能重新开放。`,
          ],
        }),
      (0, D.jsx)(Ve, {
        open: n && (!e.onboarded || Qe),
        busy: !!m,
        onDone: async () => {
          (e.onboarded || (await O(`onboard`))) && tt(!1);
        },
      }),
      (0, D.jsx)(He, {
        open: nt && !St,
        ...
        value: e.note || ``,
        saving: !!m,
        onSave: async (e) => !!(await O(`note`, { note: e })),
      }),
      ot &&
        (0, D.jsxs)(`button`, {
      ...
      ze &&
        (0, D.jsxs)(`div`, {
          ...
          children: [
            (0, D.jsx)(ee, { size: 19 }),
            (0, D.jsx)(`span`, { children: ze }),
            (0, D.jsx)(`button`, {
              "aria-label": `关闭完成提醒`,
              onClick: () => Be(``),
              children: (0, D.jsx)(we, { size: 16 }),
            }),
          ],
        }),
      _ &&
      ...
      (o === `focus` || zt) &&
        (0, D.jsxs)(`section`, {
          ...
          children: [
            ...
            ct ||
            m === `start` ||
            (M === `startReward` && m !== `roll`) ||
            M === `endReward`
              ? (0, D.jsxs)(`div`, {
                  className: `instrument reward ${m === `start` || ct ? `randomizing` : ``}`,
                  children: [
                    (0, D.jsx)(E, { size: 24 }),
                    (0, D.jsx)(`span`, {
                    ...
                    (0, D.jsx)(`strong`, {
                      children:
                        m === `start` || ct
                          ? String(ut).padStart(2, `0`)
                          : `+${k?.reward}`,
                    }),
                    (0, D.jsx)(`span`, {
                      className: `dial-bottom`,
                      children:
                        m === `start` || ct ? `好运正在发生` : `灵感点数已入账`,
                    }),
                  ],
                })
              : M === `wheelResult` || m === `spin`
                ? (0, D.jsx)(et, {
                    options: e.options,
                ...
                : M === `coinReady` ||
                    ...
                    m === `flip`
                  ? (0, D.jsxs)(`div`, {
                      className: `instrument coin coin-${wt} ${m === `flip` ? `flipping` : ``}`,
                      style: { "--skin": Je[wt] },
                      children: [
                        (0, D.jsx)(`div`, { className: `coin-rim` }),
                        (0, D.jsx)(`span`, {
                          className: `coin-caption`,
                          children: `STILL · LET CHANCE SPEAK`,
                        }),
                        M === `coin` && k.heads
                          ? (0, D.jsx)(`strong`, { children: `1` })
                          : (0, D.jsx)(Tt, { size: 136, strokeWidth: 0.8 }),
                        (0, D.jsx)(`span`, {
                          className: `coin-caption bottom`,
                          children:
                            M === `coin`
                              ? k.heads
                                ? `HEADS · 正面`
                  ...
                  : M === `ready` || m === `roll`
                    ? (0, D.jsxs)(`div`, {
                        className: `instrument dice skin-${ce} ${m === `roll` ? `rolling` : ``}`,
                        children: [
                          (0, D.jsx)(`span`, {
                            className: `dial-label`,
                            children: j
                  ...
                  !k &&
                    (0, D.jsxs)(D.Fragment, {
                      children: [
                        (0, D.jsxs)(`form`, {
                          onSubmit: (e) => {
                            (e.preventDefault(), O(`start`, { task: c }));
                          },
                          children: [
                            (0, D.jsxs)(`label`, {
                        ...
                        (0, D.jsx)(`p`, {
                          className: `hint`,
                          children: `开始与完成各获 1–100 点 · 取消扣 100 点`,
                        }),
                      ],
                    }),
                  M === `startReward` &&
                    (0, D.jsxs)(D.Fragment, {
                      children: [
                        ...
                        (0, D.jsxs)(`button`, {
                          ...
                          onClick: () => O(`roll`),
                          children: [
                            m === `roll` ? `骰子转动中…` : `摇骰子，决定时长`,
                            (0, D.jsx)(x, { size: 17 }),
                          ],
                        }),
                        (0, D.jsx)(`p`, {
                          className: `hint`,
                          children: `每点 10 分钟 · 1–6 点 · 只摇一次`,
                        }),
                      ],
                    }),
                  M === `ready` &&
                    ...
                    (0, D.jsxs)(D.Fragment, {
                      children: [
                        ...
                        e.balance < 100 &&
                          (0, D.jsxs)(`p`, {
                            className: `hint`,
                            children: [`剩余 `, e.balance, ` 点，不足以重转。`],
                          }),
                        (0, D.jsx)(`button`, {
                          className: `text-button`,
                          disabled: !!m,
                          onClick: Lt,
                          children: `也可以不执行，回去继续专注`,
                        }),
                      ],
                    }),
                  M === `coinReady` &&
                    (0, D.jsxs)(D.Fragment, {
                      children: [
                        (0, D.jsxs)(`button`, {
                          ...
                          disabled: !!m,
                          onClick: () => O(`flip`),
                          children: [`抛硬币`, (0, D.jsx)(x, { size: 17 })],
                        }),
                        (0, D.jsx)(`p`, {
                          className: `hint`,
                          children: `数字面为正 → 摇骰子休息 · 图案面为反 → 返回专注`,
                        }),
                      ],
                    }),
                  M === `coin` &&
                    (0, D.jsxs)(D.Fragment, {
                      children: [
                        !k.heads &&
                          (0, D.jsx)(`p`, {
                            className: `task-caption`,
                            children: `偶尔的落空，也是仪式的一部分。`,
                          }),
                        (0, D.jsxs)(`button`, {
                          className: `primary`,
                          disabled: !!m,
                          onClick: () => (k.heads ? O(`roll`) : Lt()),
                          children: [
                            k.heads ? `摇骰子，决定休息时长` : `返回专注`,
                            (0, D.jsx)(ne, { size: 17 }),
                          ],
                        }),
                      ],
                  ...
                  M === `restDone` &&
                    (0, D.jsxs)(D.Fragment, {
                      children: [
                        (0, D.jsxs)(`p`, {
                          className: `hint`,
                          children: [k.task, `，希望你享受其中。`],
                        }),
                        (0, D.jsxs)(`button`, {
                          className: `primary`,
                          disabled: !!m,
                          onClick: Lt,
                          children: [`回到专注`, (0, D.jsx)(xe, { size: 17 })],
                        }),
                      ],
                    }),
                ],
          ...
          children: [
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsx)(`p`, {
                  className: `eyebrow`,
                  children: `A SMALL REWARD FOR SHOWING UP`,
                }),
                (0, D.jsx)(`h1`, {
                  className: `serif`,
                  children: `把片刻，留给喜欢的事。`,
                ...
                (0, D.jsx)(`p`, {
                  className: `hint`,
                  children: `什么让你放松？把喜欢的事交给概率。`,
                }),
              ],
            }),
            (0, D.jsx)(et, { options: e.options, spinning: m === `spin` }),
            (0, D.jsxs)(`div`, {
              className: `stage-actions`,
              children: [
                (0, D.jsxs)(`button`, {
                  className: `primary`,
                  disabled: !n || e.balance < 100 || !!m,
                  onClick: () => {
                    (C(!1), O(`spin`));
                  },
                  children: [
                ...
                (0, D.jsx)(`p`, {
                  ...
                  children:
                    e.balance < 100
                      ? `还差 ${100 - e.balance} 点，先来一段专注。`
                      : `每次抽取消耗 100 点，重新抽取也一样。`,
                }),
                (0, D.jsxs)(`button`, {
                  className: `text-button`,
                  disabled: !n,
              ...
              (0, D.jsxs)(`div`, {
                ...
                children: [
                      ...
                      (0, D.jsxs)(
                        `span`,
                        {
                          children: [
                            ...
                            (0, D.jsx)(`button`, {
                              "aria-label": `删除${t}`,
                              disabled: !!m || e.options.length <= 2,
                              onClick: () =>
                                O(`options`, {
                                  options: e.options.filter((e, t) => n !== t),
                                }),
                              children: (0, D.jsx)(we, { size: 14 }),
                            }),
                          ],
                        },
                        t,
                  ...
                  (0, D.jsxs)(`form`, {
                    onSubmit: async (t) => {
                      (t.preventDefault(),
                        (await O(`options`, { options: [...e.options, ae] })) &&
                          se(``));
                    },
                    children: [
                      (0, D.jsx)(`input`, {
                        ...
                        placeholder: `再加一件喜欢的事…`,
                        "aria-label": `新的放松选项`,
                      }),
                      (0, D.jsx)(`button`, {
                        disabled: !ae.trim() || e.options.length >= 12 || !!m,
                        "aria-label": `添加放松选项`,
                        children: (0, D.jsx)(me, { size: 18 }),
                      }),
                    ],
                  }),
                  (0, D.jsx)(`p`, {
                    className: `hint`,
                    children: `2–12 个选项 · 每项最多 20 字`,
                  }),
                ],
              }),
          ],
          ...
          children: [
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsx)(`p`, {
                  className: `eyebrow`,
                  children: `LITTLE BY LITTLE, A LOT`,
                }),
                (0, D.jsx)(`h1`, { children: `每一段专注，都留下痕迹。` }),
                (0, D.jsx)(`p`, {
                  className: `hint`,
                  children: `记录只保存在此浏览器，无需登录。换设备不会同步。`,
                }),
              ],
            }),
            (0, D.jsxs)(`div`, {
              ...
              children: [
                (0, D.jsxs)(`div`, {
                  children: [
                    (0, D.jsx)(`span`, { children: `掷骰次数` }),
                    (0, D.jsxs)(`strong`, {
                      children: [
                        Mt.reduce((e, t) => e + t, 0),
                        (0, D.jsx)(`small`, { children: `次` }),
                      ],
                    }),
                  ],
                }),
                ...
                (0, D.jsxs)(`div`, {
                  children: [
                    (0, D.jsx)(`span`, { children: `连续专注` }),
                    (0, D.jsxs)(`strong`, {
                      children: [At, (0, D.jsx)(`small`, { children: `天` })],
                    }),
                  ],
                }),
                (0, D.jsxs)(`div`, {
                  children: [
                    (0, D.jsx)(`span`, { children: `累计获得数字` }),
                    (0, D.jsxs)(`strong`, {
                      children: [Nt, (0, D.jsx)(`small`, { children: `点` })],
                    }),
                  ],
                }),
              ],
            ...
            (0, D.jsx)(`p`, {
              className: `hint`,
              children: `骰子包含专注与休息；累计数字不扣除消费与处罚。旧记录仅计可确认的奖励，已取消的旧奖励可能缺失。`,
            }),
            (0, D.jsxs)(`div`, {
              ...
              children: [
                    ...
                    (0, D.jsx)(`div`, {
                      ...
                      children: [7, 30].map((e) =>
                        (0, D.jsx)(
                          `button`,
                          {
                            className: Se === e ? `selected` : ``,
                            onClick: () => Ce(e),
                            children: e === 7 ? `近 7 天` : `近 30 天`,
                          },
                          e,
                        ),
                      ),
                ...
                (0, D.jsx)(`div`, {
                  className: `bar-chart`,
                  role: `img`,
                  "aria-label": `近${Se}天专注分钟数：${kt.map((e) => `${e.d.getMonth() + 1}月${e.d.getDate()}日 ${e.mins}分钟`).join(`，`)}`,
                  children: kt.map(({ d: e, mins: t }, n) =>
                    (0, D.jsxs)(
                      `div`,
                      {
                        className: `bar-column`,
                        title: `${e.getMonth() + 1}/${e.getDate()} · ${t} 分钟`,
                        children: [
                          (0, D.jsx)(`div`, {
                            className: `bar-space`,
                            children: (0, D.jsx)(`div`, {
                              className: `bar ${n === kt.length - 1 ? `today` : ``}`,
                              style: {
                                height: `${Math.max(2, (t / Math.max(60, ...kt.map((e) => e.mins))) * 100)}%`,
                              },
                              children:
                                Se === 7 &&
                                t > 0 &&
            ...
            (0, D.jsxs)(`div`, {
              ...
              children: [
                ...
                e.history.filter((e) => Te === `all` || e.kind === Te)
                  .length === 0
                  ? (0, D.jsxs)(`div`, {
                      className: `empty`,
                      children: [
                        (0, D.jsx)(xe, { size: 30 }),
                        (0, D.jsx)(`h3`, {
                          children: `第一段专注，正等着开始。`,
                        }),
                        (0, D.jsx)(`p`, {
                          children: `完成后，你的时间与收获会出现在这里。`,
                        }),
                        (0, D.jsxs)(`button`, {
                          onClick: () => s(`focus`),
                          children: [`去专注`, (0, D.jsx)(x, { size: 16 })],
                        }),
                      ],
                    })
                  : (0, D.jsx)(`div`, {
                            ...
                            `article`,
                            {
                              children: [
                                ...
                                (0, D.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, D.jsx)(`b`, { children: e.task }),
                                    (0, D.jsxs)(`span`, {
                                      children: [
                                        new Date(e.ended).toLocaleString(
                                          `zh-CN`,
                                          {
                                            month: `short`,
                                            day: `numeric`,
                                ...
                                (0, D.jsxs)(`div`, {
                                  ...
                                  children: [
                                    !e.completed && e.kind === `focus`
                                      ? `时长不计入`
                                      : `${Math.floor(e.elapsed / 60)} 分 ${e.elapsed % 60} 秒`,
                                    (0, D.jsx)(`span`, {
      ...
      !zt &&
        o === `style` &&
        (0, D.jsxs)(`section`, {
          className: `content-page style-page`,
          children: [
            (0, D.jsxs)(`div`, {
              className: `page-heading`,
              children: [
                (0, D.jsx)(`p`, {
                  className: `eyebrow`,
                  children: `MAKE THIS MOMENT YOURS`,
                }),
                (0, D.jsx)(`h1`, { children: `一点装扮，一点心情。` }),
                (0, D.jsx)(`p`, {
                  className: `hint`,
                  children: `五套相伴的时钟与硬币。选一种此刻的心情。`,
                }),
              ],
            }),
            (0, D.jsxs)(`h2`, {
              children: [
                `时钟与硬币 `,
                (0, D.jsxs)(`span`, {
                  children: [`当前装扮 · `, Ie[ce]?.name],
                }),
              ],
            }),
            (0, D.jsx)(`div`, {
              className: `style-grid clock-grid`,
              children: Ie.map((e, t) =>
                (0, D.jsxs)(
                  `button`,
                  {
                    className: `style-card ${ce === t ? `chosen` : ``}`,
                    "aria-label": `选择${e.name}套装`,
                    "aria-pressed": ce === t,
                    onClick: () => yt(i, t, w),
                    children: [
                      (0, D.jsxs)(`div`, {
                        className: `paired-preview`,
                        children: [
                          (0, D.jsx)(Le, {
                            variant: t,
                            seconds: 1500,
                          ...
                          (0, D.jsx)(`div`, {
                            className: `paired-coin mini-coin coin-${Ye[t]}`,
                            style: { "--skin": Je[Ye[t]] },
                            children: (() => {
                              let e = qe[Ye[t]];
                              return (0, D.jsx)(e, {
                      ...
                      (0, D.jsx)(`span`, { children: e.name }),
                      (0, D.jsx)(`small`, { children: e.detail }),
                      ce === t &&
                        (0, D.jsx)(S, { className: `chosen-check`, size: 15 }),
                    ],
                  },
                  e.id,
                ),
          ...
          children: [
            Ct === 0 &&
              ...
              (0, D.jsxs)(`button`, {
                ...
                onClick: () => yt(!i, ce, w),
                "aria-label": i ? `切换日间主题` : `切换夜间主题`,
                children: [
                  i
                    ? (0, D.jsx)(ue, { size: 16 })
                    : (0, D.jsx)(be, { size: 16 }),
                  (0, D.jsx)(`span`, { children: i ? `夜间` : `日间` }),
                  (0, D.jsx)(`span`, {
            ...
            !zt &&
              ...
              (0, D.jsxs)(`div`, {
                ...
                children: [
                  (0, D.jsx)(`span`, { children: `01 随机好运` }),
                  (0, D.jsx)(`i`, {}),
                  (0, D.jsx)(`span`, { children: `02 掷出时间` }),
                  (0, D.jsx)(`i`, {}),
                  (0, D.jsx)(`span`, { children: `03 沉浸专注` }),
                ],
              }),
            (0, D.jsxs)(`div`, {
              ...
              children: [
                `今日 `,
                (0, D.jsx)(`b`, { children: Dt }),
                ` 分钟 `,
                (0, D.jsx)(`span`, { children: ` / ` }),
                (0, D.jsx)(`b`, { children: Et.length }),
                ` 次专注`,
              ],
            }),
          ],
      ...
      A &&
        (0, D.jsxs)(`button`, {
          ...
          disabled: !!m,
          onClick: () => O(bt ? `resume` : `pause`),
          children: [
            bt ? (0, D.jsx)(pe, { size: 14 }) : (0, D.jsx)(fe, { size: 14 }),
            ` `,
            bt ? (j ? `继续休息` : `继续专注`) : `暂停`,
          ],
        }),
          ...
          (0, D.jsx)(`p`, {
            children:
              M === `coin` && !k.heads
                ...
                : j
                  ? `希望你已经充好电。结束后可以继续专注。`
                  : `取消将扣除 100 点，开始奖励保留。本次专注时长不会被记录。取消后余额为 ${Math.max(-100, e.balance - 100)} 点（最低 −100）。`,
          }),
          (0, D.jsxs)(`div`, {
            className: `button-row`,
            children: [
              ...
              (0, D.jsx)(`button`, {
                ...
                disabled: !!m,
                onClick: async () => {
                  (await O(A ? `cancel` : `dismiss`)) && (b(!1), s(`focus`));
                },
                children:
                  M === `coin` && !k.heads
                    ? `回到专注`
...
function et({ options: e, selected: t, spinning: n = !1 }) {
  let r = t ? e.indexOf(t) : -1,
    i = 360 / e.length,
    a = e.map(
      (e, t) => [`var(--wheel-a)`, `var(--wheel-b)`, `var(--wheel-c)`][t % 3],
    );
  return (0, D.jsxs)(`div`, {
    ...
    children: [
      (0, D.jsx)(`div`, {
        ...
        children: t
          ? (0, D.jsx)(`strong`, { children: t })
          : (0, D.jsx)(ve, { size: 46, strokeWidth: 0.8 }),
      }),
      (0, D.jsx)(`span`, { className: `wheel-pointer` }),

      (0, D.jsx)(`div`, {
        className: `instrument wheel ${n ? `spinning` : ``}`,
        style: {
          background: `conic-gradient(${e.map((e, t) => `${a[t]} ${t * i}deg ${(t + 1) * i}deg`).join(`,`)})`,
          transform:
            !n && r >= 0 ? `rotate(${360 - (r + 0.5) * i}deg)` : void 0,
        },
        children: e.map((e, t) =>
          (0, D.jsx)(
            `span`,
            {
              ...
              title: e,
              style: {
                transform: `translate(-50%,-50%) rotate(${(t + 0.5) * i}deg) translateY(-98px) rotate(${-(t + 0.5) * i - (r >= 0 ? 360 - (r + 0.5) * i : 0)}deg)`,
              },
              children: e,
            },
            e,
      ...
      (0, D.jsx)(`div`, {
        className: `wheel-hub`,
        children: (0, D.jsx)(ve, { size: 23, strokeWidth: 1 }),
      }),
    ],
  });
}
(0, Te.createRoot)(document.getElementById(`root`)).render((0, D.jsx)(Qe, {}));
